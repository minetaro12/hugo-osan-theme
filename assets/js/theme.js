...
const toggleTheme = (theme) => {
  if(theme == "dark") {
    ...
    docstyle.style.setProperty("--a-color", "#174dba")
    docstyle.style.setProperty("--a-hover-color", "#4970be")
    docstyle.style.setProperty("--bg-color", "white")
    docstyle.style.setProperty("--fg-color", "black")
